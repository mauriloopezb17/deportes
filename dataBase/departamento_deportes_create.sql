...
-- Table: TRANSACCION_SYNC
CREATE TABLE TRANSACCION_SYNC (
    id_sync_transaccion serial NOT NULL,
    id_transaccion_caja varchar(100) NOT NULL,
    nit_ci_cliente integer NOT NULL,
    ...
    estado_sync varchar(20) NOT NULL,
    id_persona_pagador integer NULL,
    CONSTRAINT TRANSACCION_SYNC_pk PRIMARY KEY (id_sync_transaccion)
);
-- Table: PAGOS
CREATE TABLE PAGOS (
...
ADD CONSTRAINT CONCEPTOS_PAGO_DISCIPLINAS FOREIGN KEY (id_disciplina) REFERENCES DISCIPLINAS (id_disciplina) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: DELEGADOS_CARRERA_CARRERAS (table: DELEGADOS_CARRERA)
ALTER TABLE DELEGADOS_CARRERA
ADD CONSTRAINT DELEGADOS_CARRERA_CARRERAS FOREIGN KEY (id_carrera) REFERENCES CARRERAS (id_carrera) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: DELEGADOS_CARRERA_USUARIOS (table: DELEGADOS_CARRERA)
ALTER TABLE DELEGADOS_CARRERA
ADD CONSTRAINT DELEGADOS_CARRERA_USUARIOS FOREIGN KEY (id_usuario) REFERENCES USUARIOS (id_usuario) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: DEPORTISTAS_EXTERNOS_DEPORTISTAS (table: DEPORTISTAS_EXTERNOS)
ALTER TABLE DEPORTISTAS_EXTERNOS
ADD CONSTRAINT DEPORTISTAS_EXTERNOS_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: DEPORTISTAS_PERSONAS (table: DEPORTISTAS)
ALTER TABLE DEPORTISTAS
ADD CONSTRAINT DEPORTISTAS_PERSONAS FOREIGN KEY (id_persona) REFERENCES PERSONAS (id_persona) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: DEPORTISTAS_PERSONAS_TUTOR (table: DEPORTISTAS)
ALTER TABLE DEPORTISTAS
ADD CONSTRAINT DEPORTISTAS_PERSONAS_TUTOR FOREIGN KEY (id_persona_tutor) REFERENCES PERSONAS (id_persona) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: DEPORTISTAS_UCB_DEPORTISTAS (table: DEPORTISTAS_UCB)
ALTER TABLE DEPORTISTAS_UCB
ADD CONSTRAINT DEPORTISTAS_UCB_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: ENTRENADORES_USUARIOS (table: ENTRENADORES)
ALTER TABLE ENTRENADORES
ADD CONSTRAINT ENTRENADORES_USUARIOS FOREIGN KEY (id_usuario) REFERENCES USUARIOS (id_usuario) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: ENTRENADOR_ASIGNACION_CATEGORIAS (table: ENTRENADOR_ASIGNACION)
ALTER TABLE ENTRENADOR_ASIGNACION
ADD CONSTRAINT ENTRENADOR_ASIGNACION_CATEGORIAS FOREIGN KEY (id_categoria) REFERENCES CATEGORIAS (id_categoria) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: ENTRENADOR_ASIGNACION_DISCIPLINAS (table: ENTRENADOR_ASIGNACION)
ALTER TABLE ENTRENADOR_ASIGNACION
ADD CONSTRAINT ENTRENADOR_ASIGNACION_DISCIPLINAS FOREIGN KEY (id_disciplina) REFERENCES DISCIPLINAS (id_disciplina) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: ENTRENADOR_ASIGNACION_ENTRENADORES (table: ENTRENADOR_ASIGNACION)
ALTER TABLE ENTRENADOR_ASIGNACION
ADD CONSTRAINT ENTRENADOR_ASIGNACION_ENTRENADORES FOREIGN KEY (id_entrenador) REFERENCES ENTRENADORES (id_entrenador) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: EQUIPOS_CARRERAS (table: EQUIPOS)
ALTER TABLE EQUIPOS
ADD CONSTRAINT EQUIPOS_CARRERAS FOREIGN KEY (id_carrera) REFERENCES CARRERAS (id_carrera) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: EQUIPOS_PERSONAS (table: EQUIPOS)
ALTER TABLE EQUIPOS
ADD CONSTRAINT EQUIPOS_PERSONAS FOREIGN KEY (id_persona) REFERENCES PERSONAS (id_persona) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: EQUIPOS_TORNEOS (table: EQUIPOS)
ALTER TABLE EQUIPOS
ADD CONSTRAINT EQUIPOS_TORNEOS FOREIGN KEY (id_torneo) REFERENCES TORNEOS (id_torneo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: EQUIPO_JUGADORES_DEPORTISTAS (table: EQUIPO_JUGADORES)
ALTER TABLE EQUIPO_JUGADORES
ADD CONSTRAINT EQUIPO_JUGADORES_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: EQUIPO_JUGADORES_EQUIPOS (table: EQUIPO_JUGADORES)
ALTER TABLE EQUIPO_JUGADORES
ADD CONSTRAINT EQUIPO_JUGADORES_EQUIPOS FOREIGN KEY (id_equipo) REFERENCES EQUIPOS (id_equipo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: ESTADISTICAS_PARTIDO_JUGADOR_DEPORTISTAS (table: ESTADISTICAS_PARTIDO_JUGADOR)
ALTER TABLE ESTADISTICAS_PARTIDO_JUGADOR
ADD CONSTRAINT ESTADISTICAS_PARTIDO_JUGADOR_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: ESTADISTICAS_PARTIDO_JUGADOR_PARTIDOS (table: ESTADISTICAS_PARTIDO_JUGADOR)
ALTER TABLE ESTADISTICAS_PARTIDO_JUGADOR
ADD CONSTRAINT ESTADISTICAS_PARTIDO_JUGADOR_PARTIDOS FOREIGN KEY (id_partido) REFERENCES PARTIDOS (id_partido) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: FICHAS_MEDICAS_DEPORTISTAS (table: FICHAS_MEDICAS)
ALTER TABLE FICHAS_MEDICAS
ADD CONSTRAINT FICHAS_MEDICAS_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: FIXTURE_EQUIPOS_LOCAL (table: PARTIDOS)
ALTER TABLE PARTIDOS
ADD CONSTRAINT FIXTURE_EQUIPOS_LOCAL FOREIGN KEY (id_equipo_local) REFERENCES EQUIPOS (id_equipo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: FIXTURE_EQUIPOS_VISITANTES (table: PARTIDOS)
ALTER TABLE PARTIDOS
ADD CONSTRAINT FIXTURE_EQUIPOS_VISITANTES FOREIGN KEY (id_equipo_visitante) REFERENCES EQUIPOS (id_equipo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: FIXTURE_ESPACIOS (table: PARTIDOS)
ALTER TABLE PARTIDOS
ADD CONSTRAINT FIXTURE_ESPACIOS FOREIGN KEY (id_espacio) REFERENCES ESPACIOS (id_espacio) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: FIXTURE_TORNEOS (table: PARTIDOS)
ALTER TABLE PARTIDOS
ADD CONSTRAINT FIXTURE_TORNEOS FOREIGN KEY (id_torneo) REFERENCES TORNEOS (id_torneo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: GALERIA_MULTIMEDIA_CARRERAS (table: GALERIA_MULTIMEDIA)
ALTER TABLE GALERIA_MULTIMEDIA
ADD CONSTRAINT GALERIA_MULTIMEDIA_CARRERAS FOREIGN KEY (id_carrera) REFERENCES CARRERAS (id_carrera) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: GALERIA_MULTIMEDIA_ESPACIOS (table: GALERIA_MULTIMEDIA)
ALTER TABLE GALERIA_MULTIMEDIA
ADD CONSTRAINT GALERIA_MULTIMEDIA_ESPACIOS FOREIGN KEY (id_espacio) REFERENCES ESPACIOS (id_espacio) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: GALERIA_MULTIMEDIA_PARTIDOS (table: GALERIA_MULTIMEDIA)
ALTER TABLE GALERIA_MULTIMEDIA
ADD CONSTRAINT GALERIA_MULTIMEDIA_PARTIDOS FOREIGN KEY (id_partido) REFERENCES PARTIDOS (id_partido) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: GALERIA_MULTIMEDIA_TORNEOS (table: GALERIA_MULTIMEDIA)
ALTER TABLE GALERIA_MULTIMEDIA
ADD CONSTRAINT GALERIA_MULTIMEDIA_TORNEOS FOREIGN KEY (id_torneo) REFERENCES TORNEOS (id_torneo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: GALERIA_MULTIMEDIA_USUARIOS (table: GALERIA_MULTIMEDIA)
ALTER TABLE GALERIA_MULTIMEDIA
ADD CONSTRAINT GALERIA_MULTIMEDIA_USUARIOS FOREIGN KEY (id_usuario_autor) REFERENCES USUARIOS (id_usuario) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: HISTORIAL_EXPERIENCIA_DEPORTIVA_DEPORTISTAS (table: HISTORIAL_EXPERIENCIA_DEPORTIVA)
ALTER TABLE HISTORIAL_EXPERIENCIA_DEPORTIVA
ADD CONSTRAINT HISTORIAL_EXPERIENCIA_DEPORTIVA_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: INSCRIPCIONES_CATEGORIAS (table: INSCRIPCIONES)
ALTER TABLE INSCRIPCIONES
ADD CONSTRAINT INSCRIPCIONES_CATEGORIAS FOREIGN KEY (id_categoria) REFERENCES CATEGORIAS (id_categoria) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: INSCRIPCIONES_DEPORTISTAS (table: INSCRIPCIONES)
ALTER TABLE INSCRIPCIONES
ADD CONSTRAINT INSCRIPCIONES_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: INSCRIPCIONES_DISCIPLINAS (table: INSCRIPCIONES)
ALTER TABLE INSCRIPCIONES
ADD CONSTRAINT INSCRIPCIONES_DISCIPLINAS FOREIGN KEY (id_disciplina) REFERENCES DISCIPLINAS (id_disciplina) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: MEDALLERO_CARRERAS_CARRERAS (table: MEDALLERO_CARRERAS)
ALTER TABLE MEDALLERO_CARRERAS
ADD CONSTRAINT MEDALLERO_CARRERAS_CARRERAS FOREIGN KEY (id_carrera) REFERENCES CARRERAS (id_carrera) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: NOTICIAS_CATEGORIAS_NOTICIA (table: NOTICIAS)
ALTER TABLE NOTICIAS
ADD CONSTRAINT NOTICIAS_CATEGORIAS_NOTICIA FOREIGN KEY (id_categoria_noticia) REFERENCES CATEGORIAS_NOTICIA (id_categoria_noticia) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: NOTICIAS_IMAGENES_NOTICIAS (table: NOTICIAS_IMAGENES)
ALTER TABLE NOTICIAS_IMAGENES
ADD CONSTRAINT NOTICIAS_IMAGENES_NOTICIAS FOREIGN KEY (id_noticia) REFERENCES NOTICIAS (id_noticia) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: NOTICIAS_USUARIOS (table: NOTICIAS)
ALTER TABLE NOTICIAS
ADD CONSTRAINT NOTICIAS_USUARIOS FOREIGN KEY (id_usuario_autor) REFERENCES USUARIOS (id_usuario) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PAGOS_CONCEPTOS_PAGO (table: PAGOS)
ALTER TABLE PAGOS
ADD CONSTRAINT PAGOS_CONCEPTOS_PAGO FOREIGN KEY (id_concepto) REFERENCES CONCEPTOS_PAGO (id_concepto) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PAGOS_DEPORTISTAS (table: PAGOS)
ALTER TABLE PAGOS
ADD CONSTRAINT PAGOS_DEPORTISTAS FOREIGN KEY (id_deportista_beneficiario) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PAGOS_PERSONAS (table: PAGOS)
ALTER TABLE PAGOS
ADD CONSTRAINT PAGOS_PERSONAS FOREIGN KEY (id_persona_pago) REFERENCES PERSONAS (id_persona) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PLANTILLA_HORARIOS_FIJOS_DISCIPLINAS (table: PLANTILLA_HORARIOS_FIJOS)
ALTER TABLE PLANTILLA_HORARIOS_FIJOS
ADD CONSTRAINT PLANTILLA_HORARIOS_FIJOS_DISCIPLINAS FOREIGN KEY (id_disciplina) REFERENCES DISCIPLINAS (id_disciplina) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PLANTILLA_HORARIOS_FIJOS_ENTRENADORES (table: PLANTILLA_HORARIOS_FIJOS)
ALTER TABLE PLANTILLA_HORARIOS_FIJOS
ADD CONSTRAINT PLANTILLA_HORARIOS_FIJOS_ENTRENADORES FOREIGN KEY (id_entrenador) REFERENCES ENTRENADORES (id_entrenador) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PLANTILLA_HORARIOS_FIJOS_ESPACIOS (table: PLANTILLA_HORARIOS_FIJOS)
ALTER TABLE PLANTILLA_HORARIOS_FIJOS
ADD CONSTRAINT PLANTILLA_HORARIOS_FIJOS_ESPACIOS FOREIGN KEY (id_espacio) REFERENCES ESPACIOS (id_espacio) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: PLANTILLA_HORARIOS_FIJOS_TIPOS_BLOQUEO (table: PLANTILLA_HORARIOS_FIJOS)
ALTER TABLE PLANTILLA_HORARIOS_FIJOS
ADD CONSTRAINT PLANTILLA_HORARIOS_FIJOS_TIPOS_BLOQUEO FOREIGN KEY (id_tipo_bloqueo) REFERENCES TIPOS_BLOQUEO (id_tipo_bloqueo) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: REGISTROS_FEDERACION_CATEGORIAS (table: REGISTROS_FEDERACION)
ALTER TABLE REGISTROS_FEDERACION
ADD CONSTRAINT REGISTROS_FEDERACION_CATEGORIAS FOREIGN KEY (id_categoria) REFERENCES CATEGORIAS (id_categoria) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: REGISTROS_FEDERACION_DEPORTISTAS (table: REGISTROS_FEDERACION)
ALTER TABLE REGISTROS_FEDERACION
ADD CONSTRAINT REGISTROS_FEDERACION_DEPORTISTAS FOREIGN KEY (id_deportista) REFERENCES DEPORTISTAS (id_deportista) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: REGISTROS_FEDERACION_DISCIPLINAS (table: REGISTROS_FEDERACION)
ALTER TABLE REGISTROS_FEDERACION
ADD CONSTRAINT REGISTROS_FEDERACION_DISCIPLINAS FOREIGN KEY (id_disciplina) REFERENCES DISCIPLINAS (id_disciplina) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: RESERVAS_ESPACIOS (table: RESERVAS)
ALTER TABLE RESERVAS
ADD CONSTRAINT RESERVAS_ESPACIOS FOREIGN KEY (id_espacio) REFERENCES ESPACIOS (id_espacio) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: RESERVAS_PERSONAS_APROBADORES (table: RESERVAS)
ALTER TABLE RESERVAS
ADD CONSTRAINT RESERVAS_PERSONAS_APROBADORES FOREIGN KEY (id_persona_aprobador) REFERENCES PERSONAS (id_persona) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: TORNEOS_DISCIPLINAS (table: TORNEOS)
ALTER TABLE TORNEOS
ADD CONSTRAINT TORNEOS_DISCIPLINAS FOREIGN KEY (id_disciplina) REFERENCES DISCIPLINAS (id_disciplina) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: USUARIOS_PERSONAS (table: USUARIOS)
ALTER TABLE USUARIOS
ADD CONSTRAINT USUARIOS_PERSONAS FOREIGN KEY (id_persona) REFERENCES PERSONAS (id_persona) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: USUARIOS_ROLES (table: USUARIOS)
ALTER TABLE USUARIOS
ADD CONSTRAINT USUARIOS_ROLES FOREIGN KEY (id_rol) REFERENCES ROLES (id_rol) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- Reference: deportistas_ucb_CARRERAS (table: DEPORTISTAS_UCB)
ALTER TABLE DEPORTISTAS_UCB
ADD CONSTRAINT deportistas_ucb_CARRERAS FOREIGN KEY (id_carrera) REFERENCES CARRERAS (id_carrera) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE PAGOS
ADD CONSTRAINT PAGOS_TRANSACCION_SYNC FOREIGN KEY (id_transaccion_sync) REFERENCES TRANSACCION_SYNC (id_sync_transaccion) NOT DEFERRABLE INITIALLY IMMEDIATE;
-- End of file.
-- Creacion de la vista "PlanillaPagosAcademia"
DROP VIEW IF EXISTS "PlanillaPagosAcademia";
CREATE OR REPLACE VIEW "PlanillaPagosAcademia" AS WITH monto_conceptos AS (
        SELECT id_disciplina,
            MAX(
                CASE
                    WHEN LOWER(nombre) LIKE '%matrícula%'
                    OR LOWER(nombre) LIKE '%matricula%' THEN monto_actual
                    ELSE 0
                END
            ) AS monto_matricula,
            MAX(
                CASE
                    WHEN LOWER(nombre) LIKE '%mensualidad%' THEN monto_actual
                    ELSE 0
                END
            ) AS monto_mensualidad
        FROM conceptos_pago
        WHERE activo = true
        GROUP BY id_disciplina
    ),
    inscritos_con_montos AS (
        SELECT i.id_deportista,
    ...
    pagos_resumen AS (
        SELECT id_deportista_beneficiario AS deportista_id,
            gestion,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 0
                    AND estado_factura = 'Activa'
            ) > 0 AS matricula_pagada,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 1
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_1_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 2
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_2_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 3
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_3_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 4
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_4_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 5
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_5_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 6
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_6_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 7
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_7_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 8
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_8_pagado,
            COUNT(*) FILTER (
                WHERE mes_correspondiente = 9
                    AND estado_factura = 'Activa'
            ) > 0 AS mes_9_pagado,
            COALESCE(
                SUM(monto_pagado) FILTER (
                    WHERE estado_factura = 'Activa'
                ),
                0
            ) AS total_pagado
        FROM pagos
        WHERE gestion = EXTRACT(
                YEAR
                FROM CURRENT_DATE
            )::int
        GROUP BY id_deportista_beneficiario,
            gestion
    ),
    meses_academicos AS (
        SELECT LEAST(
...
SELECT d.id_deportista AS deportista_id,
    (
        p.nombres || ' ' || p.ape_paterno || ' ' || COALESCE(p.ape_materno, '')
    ) AS nombre_completo,
    d.tipo_deportista,
    EXTRACT(
        YEAR
    ...
    CASE
        ...
        ELSE GREATEST(
            0,
            COALESCE(icm.monto_matricula, 0) + COALESCE(icm.monto_mensualidad, 0) * ma.meses_transcurridos - COALESCE(pr.total_pagado, 0)
        )
...
WHERE pr.deportista_id IS NOT NULL
    OR d.tipo_deportista = 'exonerado';