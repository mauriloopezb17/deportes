...
export const demoCanchas: Cancha[] = [
  ...
  },
  {
    ...
    ubicacion: "Campus UCB - sector norte",
    capacidad: 60,
  ...
  {
    id: 4,
    nombre: "Cancha multiuso techada",
    ubicacion: "Bloque deportivo UCB - planta baja",
    capacidad: 220,
    tipo_superficie: "Cemento pulido",
    estado: "mantenimiento",
  },
  {
    id: 5,
    nombre: "Cancha de básquet exterior",
    ubicacion: "Campus UCB - patio central",
    capacidad: 150,
...
export const demoReservas: Reserva[] = [
  ...
  // Semana en curso: fechas cercanas a hoy para que el calendario abra con datos
  // visibles en lugar de quedar vacio sobre el mes actual.
  createReservation(13, 0, 0, "2026-09-01", "07:00", "08:30", "confirmada", "Entrenamiento matutino de futsal"),
  createReservation(14, 2, 4, "2026-09-01", "10:00", "11:30", "confirmada", "Clase de tenis - nivel inicial"),
  createReservation(15, 1, 8, "2026-09-01", "18:00", "20:00", "cancelada", "Cancelado por lluvia"),
  createReservation(16, 0, 2, "2026-09-02", "15:00", "16:30", "confirmada", "Fecha de futsal"),
  createReservation(17, 4, 9, "2026-09-02", "17:00", "18:30", "pendiente", "Entrenamiento de básquet"),
  createReservation(18, 1, 5, "2026-09-02", "19:00", "21:00", "confirmada", "Partido de voleibol"),
  createReservation(19, 2, 6, "2026-09-03", "08:00", "09:30", "confirmada", "Clase de tenis - nivel intermedio"),
  createReservation(20, 0, 3, "2026-09-03", "16:00", "17:30", "confirmada", "Fecha de futsal"),
  createReservation(21, 1, 10, "2026-09-03", "18:30", "20:30", "pendiente", "Partido de básquet"),
  createReservation(22, 0, 1, "2026-09-04", "07:30", "09:00", "confirmada", "Entrenamiento de futsal damas"),
  createReservation(23, 4, 11, "2026-09-04", "15:30", "17:00", "confirmada", "Entrenamiento de básquet"),
  createReservation(24, 1, 7, "2026-09-04", "18:00", "20:00", "confirmada", "Partido de voleibol"),
  createReservation(25, 2, 0, "2026-09-04", "20:30", "22:00", "pendiente", "Reserva libre - docentes"),
  createReservation(26, 0, 6, "2026-09-05", "09:00", "10:30", "confirmada", "Entrenamiento de futsal"),
  createReservation(27, 1, 4, "2026-09-05", "17:00", "19:00", "confirmada", "Partido de voleibol"),
  createReservation(28, 4, 8, "2026-09-05", "19:30", "21:00", "cancelada", "Equipo no confirmo asistencia"),
  createReservation(29, 0, 5, "2026-09-07", "16:00", "17:30", "pendiente", "Entrenamiento de futsal"),
  createReservation(30, 2, 2, "2026-09-07", "18:00", "19:30", "confirmada", "Clase de tenis - nivel avanzado"),
  createReservation(31, 1, 9, "2026-09-08", "18:30", "20:30", "confirmada", "Partido de básquet"),
  createReservation(32, 0, 3, "2026-09-09", "15:00", "16:30", "confirmada", "Fecha de futsal"),
  createReservation(33, 4, 10, "2026-09-09", "17:00", "18:30", "pendiente", "Entrenamiento de básquet"),
  createReservation(34, 1, 7, "2026-09-10", "19:00", "21:00", "confirmada", "Partido de voleibol"),
  createReservation(35, 2, 1, "2026-09-11", "08:30", "10:00", "pendiente", "Clase de tenis - nivel inicial"),
  createReservation(36, 0, 11, "2026-09-12", "10:00", "11:30", "confirmada", "Amistoso interfacultades"),
];
